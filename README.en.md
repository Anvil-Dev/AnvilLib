...
| **Collision** | AABB and triangle collision queries |
| **Explosion** | Layered explosions and melting recipe cache |
| **Font** | System fonts, SDF glyph cache and text rendering |
| **RPC** | Remote calls, return values and virtual-thread blocking calls |
| **Space Select** | Area selection, scrolling and network synchronization |
| **Sync** | Field, lazy and configuration synchronization |
| **Rendering** | Shared GUI rendering support for Font and Wheel |
...
dependencies {
    ...
    implementation "dev.anvilcraft.lib:anvillib-math-neoforge-1.21.8:2.0.0"
    implementation "dev.anvilcraft.lib:anvillib-moveable-entity-block-neoforge-1.21.8:2.0.0"
    implementation "dev.anvilcraft.lib:anvillib-multiblock-neoforge-1.21.8:2.0.0"
    ...
    implementation "dev.anvilcraft.lib:anvillib-util-neoforge-1.21.8:2.0.0"
...
This branch includes the new modules and features from the local 1.21.1 branch. See the [porting record](PORTING_1_21_1_TO_1_21_8.md) for module coverage, platform adaptations, and validation.
