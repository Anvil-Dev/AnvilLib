...
public final class WheelTestClientHandler {
    ...
    public static void onKeyInput(InputEvent.Key event) {
        ...
        boolean holdDotKey = WheelTestKeys.HOLD_KEY.matches(event.getKey(), event.getScanCode());
        boolean holdAnnularKey = WheelTestKeys.HOLD_ANNULAR_KEY.matches(event.getKey(), event.getScanCode());
