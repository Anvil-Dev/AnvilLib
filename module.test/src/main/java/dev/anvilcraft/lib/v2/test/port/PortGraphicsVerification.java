...
public final class PortGraphicsVerification {
    ...
    public static boolean tick() {
        ...
        if (ticks == 22) minecraft.setScreen(new Screen(Component.literal("AnvilLib 字体验证")) {
            ...
            @Override public void render(GuiGraphics graphics, int x, int y, float partial) {
                ...
                GuiGraphicsExtractorExtension extension = (GuiGraphicsExtractorExtension) graphics;
                extension.anvillib$centeredText(AnvilLibFont.getSelectFont(), Component.literal("AnvilLib 1.21.4"), width / 2, height / 2 - 20, -1);
    ...
    private static void screenshot(String name) {
        Minecraft minecraft = Minecraft.getInstance();
        net.minecraft.client.Screenshot.grab(minecraft.gameDirectory, name, minecraft.getMainRenderTarget(), message -> { });
    }
}
