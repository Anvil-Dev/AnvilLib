...
public final class SdfGraphics {
    ...
    private record RenderState(
        ...
        public void buildVertices(VertexConsumer consumer, float z) {
            consumer.addVertexWith2DPose(this.pose(), -0.5f, -0.5f, z).setUv(0, 0).setUv1(this.index(), 0).setColor(this.color());
            consumer.addVertexWith2DPose(this.pose(), -0.5f, +0.5f, z).setUv(0, 1).setUv1(this.index(), 0).setColor(this.color());
            consumer.addVertexWith2DPose(this.pose(), +0.5f, +0.5f, z).setUv(1, 1).setUv1(this.index(), 0).setColor(this.color());
            consumer.addVertexWith2DPose(this.pose(), +0.5f, -0.5f, z).setUv(1, 0).setUv1(this.index(), 0).setColor(this.color());
        }
