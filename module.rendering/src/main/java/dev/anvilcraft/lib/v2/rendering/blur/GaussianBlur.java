...
public class GaussianBlur implements AutoCloseable {
    private final RenderTarget inputTarget = new TextureTarget("BlurInput", 854, 480, false);
    ...
    private void blurOnce(CommandEncoder commandEncoder, GpuTexture inputTarget, RenderTarget outputTarget, boolean horizontal) {
        ...
        try (var inputView = device.createTextureView(inputTarget);
            ...
            blurPass.bindSampler("DiffuseSampler", inputView);
    ...
    public void resize(int width, int height) {
        ...
        inputTarget.getColorTexture().setTextureFilter(FilterMode.LINEAR, false);
        tempTarget.getColorTexture().setTextureFilter(FilterMode.LINEAR, false);
