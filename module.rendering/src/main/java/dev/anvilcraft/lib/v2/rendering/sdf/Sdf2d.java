...
public class Sdf2d {
    ...
    public static float sdCircle(
        ...
        return          (float) Mth.length(px, py) - r;
    }
    ...
    public static float sdArc(
        ...
        if (scy * px > scx * py) {
            var dx      = px - scx * ra;
            var dy      = py - scy * ra;
            result      = (float) Mth.length(dx, dy);
        } else {
            result      = Math.abs((float) Mth.length(px, py) - ra);
        }
    ...
    public static float sdRing(
        ...
        float a         = Math.abs((float) Mth.length(rx, ry) - r) - th * 0.5f;

        float by        = Math.max(0.0f,
                        Math.abs(r - ry) - th * 0.5f);

        float b         = (float) Mth.length(rx, by) *
                        Mth.sign(rx);
    ...
    public static float sdPie(
        ...
        float l =       (float) Mth.length(px, py) - r;
        ...
        float m         = (float) Mth.length(mx, my);
    ...
    public static float sdUnevenCapsule(
        ...
        if (k           < 0.0f) {
            return      (float) Mth.length(px, py) - r1;
        }
        ...
        if (k           > a * h) {
            ...
            return      (float) Mth.length(dx, dy) - r2;
        }
    ...
    public static float sdEgg(
        ...
        if (py          < 0.0f) {
            ...
            return      (float) Mth.length(px, py) - ra;
        }
    ...
    public static float sdEquilateralTriangle(
        ...
        return          -(float) Mth.length(px, py) * Mth.sign(py);
    }
