...
public class IntegrationManager {
    ...
    public void compileContent() {
        ModFileInfo fileInfo = net.neoforged.fml.loading.LoadingModList.get().getModFileById(this.modId);
    ...
    public void loadAllIntegrations() {
        for (String key : instances.keySet()) {
            Optional<ModInfo> info = net.neoforged.fml.loading.LoadingModList.get().getMods().stream().filter(it -> it.getModId().equals(key)).findFirst();
