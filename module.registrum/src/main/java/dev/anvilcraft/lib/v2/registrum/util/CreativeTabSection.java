...
public record CreativeTabSection(
    ...
    public static Builder builder(Identifier bannerTexture) {
    ...
    public static final class Builder {
        private final Identifier bannerTexture;
        ...
        private Builder(Identifier bannerTexture) {
