...
public final class CreativeVariantPickerOverlay {
    ...
    public void render(
        ...
        try {
            ...
            for (int index = 0; index < this.variants.size(); index++) {
                ...
                graphics.item(variant, itemX, itemY, index);
                graphics.itemDecorations(Minecraft.getInstance().font, variant, itemX, itemY);
            }
    ...
    private void renderCarriedItem(GuiGraphicsExtractor graphics, ItemStack stack, int mouseX, int mouseY) {
