...
public class DistrictRenderer {
    @SubscribeEvent
    public static void addLevelRenderMainPass(RenderLevelStageEvent event) {
    ...
    public static void renderDistrict(
        ...
        for (District district : districts) {
            ...
            if (SharedConstants.DEBUG_SHAPES) {
                ...
                net.minecraft.client.renderer.ShapeRenderer.renderLineBox(poseStack, buffer, box, 1.0F, 1.0F, 1.0F, 1.0F);
            } else {
                ...
                net.minecraft.client.renderer.ShapeRenderer.renderShape(poseStack, buffer, district.shape(), dx, dy, dz, color);
            }
        }
