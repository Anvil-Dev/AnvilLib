...
public record FrostedDiscRenderState(
    ...
    public void buildVertices(VertexConsumer consumer, float z) {
        ...
        consumer.addVertexWith2DPose(this.pose(), this.x0(), this.y0(), z).setUv(0f, 1f).setColor(this.color());
        consumer.addVertexWith2DPose(this.pose(), this.x0(), this.y1(), z).setUv(0f, 0f).setColor(this.color());
        consumer.addVertexWith2DPose(this.pose(), this.x1(), this.y1(), z).setUv(1f, 0f).setColor(this.color());
        consumer.addVertexWith2DPose(this.pose(), this.x1(), this.y0(), z).setUv(1f, 1f).setColor(this.color());
    }
}
