...
public class WheelWidget extends AbstractWidget {
    ...
    public void renderFrostedBackground(
        ...
        try {
            ...
            CompiledShaderProgram frostedDiscShader = LibShaders.getFrostedDiscShader();
    ...
    public void renderSelectionEffect(GuiGraphics guiGraphics, float centerX, float centerY, int color, float ringWidth) {
        ...
        RenderSystem.enableBlend();
        RenderSystem.defaultBlendFunc();
        CompiledShaderProgram selectionShader = LibShaders.getSelectionShader();
    ...
    public void renderAnnularSectorSelection(
        ...
        RenderSystem.enableBlend();
        RenderSystem.defaultBlendFunc();
        CompiledShaderProgram annularSectorShader = LibShaders.getAnnularSectorShader();
    ...
    private void renderSegment(
        ...
        RenderSystem.enableBlend();
        RenderSystem.defaultBlendFunc();
        CompiledShaderProgram segmentShader = LibShaders.getSegmentShader();
    ...
    private void renderDisc(GuiGraphics guiGraphics, float centerX, float centerY, float radius, int color) {
        ...
        RenderSystem.enableBlend();
        RenderSystem.defaultBlendFunc();
        CompiledShaderProgram discShader = LibShaders.getDiscShader();
        if (discShader == null) {
    ...
    public static void renderRing(
        ...
        RenderSystem.enableBlend();
        RenderSystem.defaultBlendFunc();
        CompiledShaderProgram ringShader = LibShaders.getRingShader();
        if (ringShader == null) {
