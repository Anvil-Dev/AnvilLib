...
public final class WheelFrostedBackground implements AutoCloseable {
    ...
    private TextureTarget firstTarget = new TextureTarget(2, 2, true);
    private TextureTarget secondTarget = new TextureTarget(2, 2, true);
    private int width;
    private int height;
    ...
    private void blurOnce(
        ...
        CompiledShaderProgram blurShader = LibShaders.getBlurShader();
        if (blurShader == null) {
    ...
    private void guardSize(RenderTarget mainTarget) {
        ...
        this.firstTarget = new TextureTarget(this.width, this.height, true);
        this.secondTarget = new TextureTarget(this.width, this.height, true);
    }
