...
public final class ModelSelections {
    ...
    private final Map<BlockStateModelPart, ModelCapture.Source> sources;
    ...
    private ModelSelections(Map<BlockStateModelPart, ModelCapture.Source> sources) { this.sources = sources; }
    ...
    private @Nullable ModelSelection resolve(BlockStateModel model, BlockState state, int depth) {
        ...
        BlockStateModelPart leaf = model instanceof SingleVariantAccessor single ? single.anvillib_cube$model() : null;
