...
public final class ModelCapture {
    ...
    public static synchronized void remember(BlockModel model, ModelState state, BakedModel baked) {
        if (model.customData.getCustomGeometry() != null || model.getElements().isEmpty() || baked.isCustomRenderer()) return;
        ...
        SOURCES.put(baked, new Source(model.getElements(), transformed));
    }
